...
WhitneyGroup:
	...
	db 20, TEDDIURSA,  FURY_SWIPES, CURSE, ATTRACT, LICK
...
BugsyGroup:
	...
	db 14, BUTTERFREE, CONFUSION, STRING_SHOT, HARDEN, NO_MOVE
	db 14, BEEDRILL,   POISON_STING, CUT, HARDEN, NO_MOVE
	db 16, SCYTHER,    GUST, LEER, FURY_CUTTER, QUICK_ATTACK
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 24, STANTLER,   HYPNOSIS, STOMP, DREAM_EATER, NIGHTMARE
	db 24, MISDREAVUS, CONFUSE_RAY, PSYBEAM, SHADOW_BALL, MEAN_LOOK
...
TwinsGroup:
	...
	db 16, WIGGLYTUFF, SING, DEFENSE_CURL, POUND, DISABLE
	db -1 ; end
