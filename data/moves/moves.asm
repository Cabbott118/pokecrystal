...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         80, NORMAL,       100, 20,   0
	...
	move CUT,          EFFECT_NORMAL_HIT,         70, BUG,        	 95, 30,   0
	...
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, FIGHTING,      85,  5,   0
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,       100, 20,   0
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,         85,  5,   0
	...
	move SOLARBEAM,    EFFECT_SOLARBEAM,         150, GRASS,        100, 10,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        15, FIRE,          85, 15,   0
	...
	move DIG,          EFFECT_FLY,                90, GROUND,       100, 10,   0
	...
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, ICE,       	100, 15,   0
	...
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        180, FLYING,        95,  5,   0
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,       100, 10,   0
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     20, WATER,        100, 30,  30
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,       100, 10,  30
	move SPORE,        EFFECT_SLEEP,               0, GRASS,        100, 15,   0
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  50, ELECTRIC,     100, 20,   0
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         85, ROCK,         100, 10,  30
	...
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,          100, 25,  50
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  50, GROUND,       100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         95, 10,  50
	...
	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        90, NORMAL,       100, 40,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     90, STEEL,         90, 25,  10
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,        100, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,         95, 35, 100
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,     100,  5,   0
